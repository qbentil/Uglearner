                                        ...
                                        <div class="">
                                            <div class="form-group row">
                                                <div class="col-sm-12  ml-auto">
                                                    <h6 class="text-primary">1. Personal Details</h6>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 ml-auto">
                                                    <h6 class="m-form__section text-primary">2. Social Links</h6>
                                                </div>
                                            </div>
                                            ...
                                            <div class="">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <button type="reset" class="btn-secondry image-preview-clear">Cancel</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
